    ...
    <section class="content">
        <div class="row">
          ...
          <div class="col-xs-9">
              <div class="box">
                  <!-- form start -->
              <form id="form-submit" role="form" method="POST" action="{{ route('admin.update',["admin"=>$post->id])}}" enctype="multipart/form-data" >
                @csrf
                @method("PUT")
                    <div class="box-body">
                    <div class="form-group @error('title') has-error  @enderror">
                        ...
                        <input value="{{$post->title}}" type="text" name="title" placeholder="Enter Title here" id="title" class="form-control"
                      ...
                      <div class="form-group @error('slug') has-error  @enderror">
                        ...
                        <input value="{{$post->slug}}" type="text" name="slug"  class="form-control" id="slug" aria-labelledby="slug" placeholder="Example: web-design">
                      ...
                      <div class="form-group @error('excerpt') has-error  @enderror">
                        ...
                        <textarea value="{{old('excerpt')}}" name="excerpt" id="excerpt" rows="5" class="form-control excerpt" aria-labelledby="excerpt" placeholder="Enter a short description of your post.">{{$post->excerpt}}</textarea>
                        @error('excerpt')
                      ...
                      <div class="form-group @error('body') has-error  @enderror">
                        ...
                        <textarea value="{{old('body')}}" name="body" id="body" rows="10" class="form-control " aria-labelledby="body"
                          placeholder="Enter your complete post here.">{{$post->body}}</textarea>
                          @error('body')
          ...
          <div class="col-md-3">
              <div class="box">
                  ...
                  <div class="box-body">
                    <div class="form-group @error('published_at') has-error  @enderror">
                      <label for="published_at">Published date</label>
                        ...
                        <input value="{{$post->published_at}}" type="date" name="published_at"  class="form-control" id="published_at" aria-labelledby="published_at" placeholder="Choose the publication date">
                  ...
                  <div class="box-footer clearfix">
                      <div class="pull-left">
                          <a href="{{ route('admin.update',["admin"=>$post->id])}}" onclick="draftFunction(event);" class="btn btn-warning">Save Draft</a>
                      </div>
                      <div class="pull-right">
                          <a href="{{ route('admin.update',["admin"=>$post->id])}}" class="btn btn-primary" 
                  ...
                  <div class="box-body text-center">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                          <div class="fileinput-new img-thumbnail" style="width: 200px; height: 150px;">
                            <img src="{{asset('assets/frontend/img'.'/'.$post->image)}}"  alt="{{$post->title}}">
                          </div>
